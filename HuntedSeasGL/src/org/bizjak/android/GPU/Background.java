...
public class Background {
	...
	Background(int startX, int startY, int width, int height, int depth, Sea host, int resource, boolean moves){
...
//		
	...
	public void draw(int programHandle){
        ...
        int mTimeHandler = GLES20.glGetUniformLocation(programHandle, "mTime");//TODO premakni get za optimizacijo
...
//        GLES20.glUniform4fv(mTouchHandler, touch.length, touch,0); <-------- TODO to je neki narobe NUJNO POPRAVI TA DEL!!!!
