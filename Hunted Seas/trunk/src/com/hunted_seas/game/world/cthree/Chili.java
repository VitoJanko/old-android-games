 ...
 *
 */
public class Chili extends Sprite {
	public static final String FOLDER = "common_elements/collectable/";
	public static String texture = FOLDER + "chili";
	
	public static int model = R.raw.chili;
	...
	public Chili(float x, float y, float z, LevelManager manager){
		super(x, y, z, 0, 1);
		collision = true;
