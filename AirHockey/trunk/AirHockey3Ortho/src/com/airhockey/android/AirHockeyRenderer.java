...
public class AirHockeyRenderer implements Renderer{
	...
	public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
		...
		aColorLocation = glGetAttribLocation(program, A_COLOR); // get location of atribute this is automatic and can't be assigned manually
		...
		uMatrixLocation = glGetUniformLocation(program, U_MATRIX);//get location of matrix
